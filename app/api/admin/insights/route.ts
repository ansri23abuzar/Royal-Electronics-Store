...
export async function GET() {
  try {
    ...
    // Build fallback insights in case AI is not configured or fails
    ...
    let insights: typeof fallbackInsights = fallbackInsights;

    // Generate AI insights only if the AI gateway is configured
...
Generate insights in the required JSON format.`,
      ...
      try {
        ...
        // Keep fallback insights if parsing fails
      }
    }
